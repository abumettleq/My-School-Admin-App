              ...
              children: [
                ...
                Center(
                  child: SearchBar(
                    ...
                    controller: userProvider.searchStudentsController,
                    onChanged: (value) {
                      searchedStudents = userProvider.searchStudents(value);
                    },
                  ),
                ),
                SizedBox(
                        ...
                        child: Builder(builder: (context) {
                          return userProvider.isStudentDataLoading
                              ...
                              : userProvider.studentsData.isEmpty
                                  ...
                                  : userProvider.searchStudentsController.text
                                          .isNotEmpty
                        ...
                        children: [
                          ...
                          Consumer<UserProvider>(
                            ...
                            return IconButton(
                                ...
                                onPressed: () {
                                  userProvider.deleteUser(userProvider
                                      .studentsData[index].studentID);
                                },
                                icon: Icon(
